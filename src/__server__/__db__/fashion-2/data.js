...
export const mainCarouselData = [
  ...
  },
  {
    ...
    imgUrl: "/assets/images/inflatables/island-fire-combo.png",
    description: "Wet or dry options that keep the party moving from first jump to final slide."
  }
];

// categories (unused for this rental-focused layout)
...
export const serviceList = [
  {
    ...
    description: "We arrive early and get it ready to jump."
  },
  {
    id: "service-safety",
    icon: "Shield",
    title: "Safety First",
    description: "Cleaned, inspected, and secured every time."
  },
  {
    id: "service-scheduling",
    icon: "AlarmClock",
    title: "Flexible Scheduling",
    description: "Perfect for parties, schools, and events."
  }
];
...
export const products = [
  ...
  },
  {
    ...
    thumbnail: "/assets/images/inflatables/island-fire-combo.png",
    images: [
      "/assets/images/inflatables/island-fire-combo.png"
    ],
