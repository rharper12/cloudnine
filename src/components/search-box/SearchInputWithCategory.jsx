...
const SearchInputWithCategory = () => {
  ...
  const [categoryTitle, setCategoryTitle] = useState("All Rentals");
  ...
  return <Box position="relative" flex="1 1 0" maxWidth="670px" mx="auto" {...{
    ref: parentRef
      ...
      <TextField fullWidth variant="outlined" placeholder="Search rentals..." onChange={handleSearch} InputProps={{
      sx: {
        height: 44,
        paddingRight: 0,
        borderRadius: 300,
